...
then
        ...
        echo "downloading and extracting bbb_sunflower_native_60fps_stereo_abl.mp4 testset"
        sudo wget -nc http://distribution.bbb3d.renderfarming.net/video/mp4/bbb_sunflower_native_60fps_stereo_abl.mp4

        echo "copying bbb_sunflower_native_60fps_stereo_abl.mp4 to ramdisk"
        sudo dd if=bbb_sunflower_native_60fps_stereo_abl.mp4 of=/mnt/ramdisk/bbb_sunflower_native_60fps_stereo_abl.mp4 bs=1M count=1000
        cd /mnt/ramdisk/
        chksum=`sha256sum bbb_sunflower_native_60fps_stereo_abl.mp4`
        cd -
	echo "Test with mp4 file" >> ./test_results_$now.txt
	...
	echo "" >> ./test_results_$now.txt
        ...
        do
                ...
                sudo dd if=/mnt/ramdisk/bbb_sunflower_native_60fps_stereo_abl.mp4 of=/testpool/fs1/bbb_sunflower_native_60fps_stereo_abl.mp4 bs=4M  2>> ./test_results_$now.txt
                ...
                sudo rm bbb_sunflower_native_60fps_stereo_abl.mp4
                cd -
